...
(function() {
  'use strict';
  var $, $async, CND, PATH, PD, assign, badge, collapse_text, copy, debug, declare, echo, has_full_signatures, help, info, isa, jr, partition, rpr, select, size_of, type_of, types, urge, validate, warn, whisper;
