...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.definitions_from_path = function(path) {
    return new Promise((resolve, reject) => {
      return this._read_definitions(PD.read_from_file(path), (error, R) => {
        if (error != null) {
          return reject(error);
        }
        return resolve(R);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.definitions_from_path_sync = function(path) {
    return this.definitions_from_text((require('fs')).readFileSync(path));
  };

  this.definitions_from_text = function(text) {
    return this._read_definitions(PD.new_value_source([text]));
  };

  //-----------------------------------------------------------------------------------------------------------
  this._read_definitions = function(source, handler) {
