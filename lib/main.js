...
(function() {
  'use strict';
  var $, $async, CND, PATH, PD, assign, badge, collapse_text, copy, debug, echo, help, info, jr, rpr, select, urge, warn, whisper;
  ...
  this.$compile_definitions = function(S) {
    ...
    //.........................................................................................................
    return $((d, send) => {
      var argument, i, len, location, match, name, ref, signature, text, type;
      //.......................................................................................................
      if (select(d, '<definition')) {
        name = d.value.icname;
        type = d.value.ictype;
  ...
  this.$collect = function(S, collector) {
    return $((d, send) => {
      var arity, definition, entry, lnr, location, name1, signature, text;
      if (!select(d, '^definition')) {
      ...
      lnr = d.$.line;
      definition = d.value;
      entry = (collector[name1 = definition.name] != null ? collector[name1] : collector[name1] = {
        arity: {},
        type: definition.type
      });
      arity = definition.signature != null ? definition.signature.length : 'null';
      ({text, location, signature} = definition);
      //.......................................................................................................
      if (d.value.type !== entry.type) {
        throw new Error(`µ94432 expected type ${rpr(entry.type)}, got ${rpr(definition.type)} (#${lnr})`);
      }
      //.......................................................................................................
      if (entry.arity[arity] != null) {
        throw new Error(`µ23983 name ${definition.name} arity ${arity} already defined: ${rpr(definition)} (#${lnr})`);
      }
      //.......................................................................................................
      if (arity === 'null' && (Object.keys(entry.arity)).length > 0) {
      ...
      if (signature != null) {
        entry.arity[arity].signature = signature;
      }
      //.......................................................................................................
      return null;
    });
