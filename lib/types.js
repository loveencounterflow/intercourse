(function() {
  ...
  this.declare('ic_toplevel_entry', {
    tests: {
      ...
      "? has key 'type'": function(x) {
        return this.has_key(x, 'type');
      },
  ...
  this.declare('ic_signature_entry', {
    tests: {
      ...
      "? has key 'location'": function(x) {
        return this.has_key(x, 'location');
      },
      "? has key 'kenning'": function(x) {
        return this.has_key(x, 'kenning');
      },
      "? has key 'type'": function(x) {
        return this.has_key(x, 'type');
      },
      ...
      "? has key 'parts'": function(x) {
        return this.has_key(x, 'parts');
      },
  ...
  this.declare('ic_location', {
    tests: {
      ...
      "? has key 'line_nr'": function(x) {
        return this.has_key(x, 'line_nr');
      },
  ...
  this.declare('ic_settings', {
    tests: {
      ...
      "? has key 'partition'": function(x) {
        return this.has_key(x, 'partition');
      },
      "? has key 'comments'": function(x) {
        return this.has_key(x, 'comments');
      },
