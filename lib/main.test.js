...
(function() {
  ...
  this.read_definitions = function(path) {
    return this._read_definitions(PD.read_from_file(path));
  };

  this.read_definitions_from_text = function(text) {
    return this._read_definitions(PD.new_source_from_values(text));
  };
